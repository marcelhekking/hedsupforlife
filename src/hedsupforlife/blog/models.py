...
from hedsupforlife.utils.blocks import ImageBlock, StoryBlock
from hedsupforlife.utils.models import ArticleTopic, BasePage
...
class BlogListingPage(BasePage):
    template = "pages/blog_listing_page.html"
    subpage_types = ["blog.ArticlePage"]
    max_count = 1  # Allow only one blog listing page to keep blog pages in one place
