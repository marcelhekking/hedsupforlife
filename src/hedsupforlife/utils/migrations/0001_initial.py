    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('footer_newsletter_signup_link', models.URLField(blank=True, help_text='Link to the newsletter signup form. If left blank, the signup CTA will not be displayed.')),
