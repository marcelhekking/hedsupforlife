...
class Rendition(AbstractRendition):
    ...
    def object_position_style(self):
        """
        Returns a `object-position` rule to add to an img element's inline
        style  attribute.

        Similar code is used for wagtail image's background_position_style method.
        Reference: https://github.com/wagtail/wagtail/blob/
          845a2acb365241643c2f453e4b962a586ae5e713/wagtail/images/models.py#L1229
        """
